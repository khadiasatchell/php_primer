...
<head>
    ...
    crossorigin="anonymous">    <title>PHP Primer - <?php echo $title ?></title>
</head>
<body>
    <div class="container">
    ...
    <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link" href="whileldowhileloop.php">Simple while Loop/Do While Loop</a></li>
